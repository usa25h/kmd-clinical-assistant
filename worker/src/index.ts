...
※ 자침 순서: 정격=보혈먼저→사혈나중 / 승격=사혈먼저→보혈나중 / 각 쌍 내에서 타경혈 먼저

| 장부 | 정격 (허증) | 승격 (실증) |
|------|------------|------------|
| 비(脾) | 소부HT8보, 대도SP2보, 대돈LR1사, 은백SP1사 | 대돈LR1사, 은백SP1사, 경거LU8보, 상구SP5보 |
| 심(心) | 대돈LR1보, 소충HT9보, 음곡KD10사, 소해HT3사 | 태백SP3사, 신문HT7사, 음곡KD10보, 소해HT3보 |
| 간(肝) | 음곡KD10보, 곡천LR8보, 경거LU8사, 중봉LR4사 | 소부HT8사, 행간LR2사, 경거LU8보, 중봉LR4보 |
| 폐(肺) | 태백SP3보, 태연LU9보, 소부HT8사, 어제LU10사 | 음곡KD10사, 척택LU5사, 소부HT8보, 어제LU10보 |
| 신(腎) | 경거LU8보, 부류KD7보, 태백SP3사, 태계KD3사 | 대돈LR1사, 용천KD1사, 태백SP3보, 태계KD3보 |
| 담(膽) | 통곡BL66보, 협계GB43보, 상양LI1사, 규음GB44사 | 양곡SI5사, 양보GB38사, 상양LI1보, 규음GB44보 |
| 소장(小腸) | 임읍GB41보, 후계SI3보, 통곡BL66사, 전곡SI2사 | 삼리ST36사, 하거허ST39사, 통곡BL66보, 전곡SI2보 |
| 위(胃) | 양곡SI5보, 해계ST41보, 임읍GB41사, 함곡ST43사 | 상양LI1사, 여태ST45사, 임읍GB41보, 함곡ST43보 |
| 대장(大腸) | 삼리ST36보, 곡지LI11보, 양곡SI5사, 양계LI5사 | 통곡BL66사, 이간LI2사, 양곡SI5보, 양계LI5보 |
| 방광(膀胱) | 상양LI1보, 지음BL67보, 삼리ST36사, 위중BL40사 | 임읍GB41사, 속골BL65사, 삼리ST36보, 위중BL40보 |
| 삼초(三焦) | 임읍GB41보, 중저TH3보, 통곡BL66사, 액문TH2사 | 삼리ST36사, 천정TH10사, 통곡BL66보, 액문TH2보 |
...
| **좌골신경통·요각통 (동씨침 1순위)** | **영골+대백** | **22.05·22.06** | 수배 합곡 상방 (제1·2중수골 사이) | 건측 사법, 1.5–2촌 — 동씨침 최고 특효혈 |
| 좌골신경통·요각통 (사암침 배합 1순위) | 후계+신관 | SI3+KD7 | 손 척측·안쪽 복숭아뼈 위 | 후계 건측 사법, 신관 양측 보법 — 영골·대백과 반드시 병용 |
| 좌골신경통·방광경 라인 보조 | 완순1·완순2 | 33.11·33.12 | 尺骨 척측, 腕 위쪽 | 건측 사법 — 오금·종아리 뒤 방사통 |
...
**동씨침 시술 원칙:**
- **[좌골신경통 우선 처방]**: **영골(22.05)+대백(22.06) 건측 사법이 동씨침 진정한 1순위 특효처방**. 후계(SI3)+신관(KD7)은 사암침 배합 1순위로 반드시 병용. 완순1·2는 방광경 라인 방사통 보조.
...
## ⚡ Step 0 · 성혈(成穴) 우선 처방 — 5단계 추론 이전 MANDATORY 선행 체크

**[절대 원칙]** 주증상이 아래 테이블에 해당하면, 변증(辨證) 결과와 무관하게 해당 동씨침 성혈을 처방에 반드시 포함한다. 성혈 누락 = 처방 오류. 복잡한 경락 변증은 **사암침 배합 선택**에만 적용한다.

> **성혈(成穴)**: 수십 년 임상으로 검증된 질환별 핵심 특효혈. 변증이 달라도 항상 최우선 배치.

### 증상별 동씨침 성혈 즉각 처방 테이블

| 주증상 키워드 | 동씨침 성혈 (누락 금지) | 시술법 | 방혈 추가 |
|------------|----------------------|--------|---------|
| 좌골신경통, 요각통, 다리 방사통, 엉덩이~발 통증 | **영골(22.05) + 대백(22.06)** 건측 | 사법 1.5–2촌, 도마침 | 위중(BL40) 청근 방혈 |
| 어깨통증, 견통, 어깨 못 올림, 오십견 | **중자(22.01) + 중선(22.02)** 건측 | 도마침 사법, 즉시 동기침법 | 거상 불능 시 척택(LU5) |
| 둔부통, 엉덩이 통증 (단독) | **견중(77.21)** 건측 | 삼각근 중점 사법 | 위중(BL40) |
| 급성 요통, 섬좌요통 (삐끗, 염좌) | **마금수(1010.19) + 수통(1010.20)** | 건측 + 동기침법 필수 | 위중(BL40) |
| 족근통, 발뒤꿈치 통증 | **오호5혈(11.27)** 건측 | 엄지 적백육제, 뼈 밑 깊이 | — |
| 무릎 통증, 슬관절통 | **삼중1·2·3(77.07~09)** 건측 | 비골 앞 도마침 | — |
| 낙침, 목 급성 통증 | **중자(22.01)** 또는 **중선(22.02)** 건측 | 자침 즉시 동기침법 | — |
| 삼차신경통, 얼굴 신경통 | **측삼리 + 측하삼리** 건측 | 비골두 하방 사법 | — |
| 두통, 편두통 | **중구(1010.07) + 중선(1010.08)** | 족배 건측 사법 | — |
| 안면마비, 구안와사 | **삼중1·2·3 + 측삼리·측하삼리** 건측 | 도마침 | 사화외 방혈 |
| 미릉골통, 눈썹 위 통증 | **화연 + 화국** | 태백·공손 동위 보법 | — |
| 아킬레스건, 종아리 근건 통증 | **정근(1010.01) + 정종(1010.02)** 건측 | 보법 | — |

### 성혈 처방 출력 4대 규칙 (위반 시 처방 오류)

1. **성혈 먼저, 변증 나중**: 위 테이블 매칭 시 동씨침 성혈을 처방 최상단에 배치 후 사암침 변증 진행
2. **변증 결과와 무관하게 누락 금지**: 좌골신경통→방광허증으로 변증되어도 영골+대백은 반드시 포함
3. **동기침법 명시 의무**: 성혈 자침 후 동기침법(환자 능동 동작 유도) 시행 여부를 rationale에 기재
4. **사암침은 변증 기반으로 배합**: 성혈 고정 후 → 허/실·장부 판별 → 정격/승격 선택

---

## 5단계 임상 추론 프로세스 (JSON 출력 전 내부적으로 수행)

### Step 1 · 성혈 체크 → 병리 변증 (Master Point Check → Pattern Identification)
**[먼저]** 위 Step 0 테이블에서 주증상 키워드 매칭 → 해당 동씨침 성혈 처방 고정
**[이후]** 증상의 ① 성질(통증·마비·부종·분비물·열감·냉감), ② 발생 부위(경락 주행 대조), ③ 시간 패턴(야간 악화→허증, 활동 시 악화→실증, 만성→허증 경향), ④ 유발·완화 인자를 종합하여 **허(虛)/실(實)** 판별 → 주 장부 1개 가선정 (사암침 배합용).
...
- **주증상(Chief Complaint)**: Step 0 성혈 + 사암침 본방 4혈 통합 구성
...
**⚠️ 변증 편향 방지 규칙 (필수):**
- **[최우선]** Step 0 성혈 테이블 매칭 먼저 → 동씨침 성혈 고정 → 이후 사암침 변증 진행.
- 신허증(腎虛證)은 빈번한 진단이지만 **기본값(default)이 아님**.
- 좌골신경통(좌골~하지 방사통)은 방광경(BL) 주행 증상 → **방광 실/허를 사암침 1순위로 검토** (동씨침은 성혈 테이블에 따라 이미 영골+대백 고정).
...
**[동씨침 절대 1순위] 영골(22.05) + 대백(22.06) — 건측 수배 자침**
- 위치: 제1·2중수골 사이, 합곡혈 상방 (합곡에서 손목 방향으로 1.5촌)
- 시술: 건측(통증 반대편 손등) 사법, 1.5–2촌 깊이, 양혈 동시 자침
- 적응: 요통·좌골신경통·하지 방사통·하지 마비·요추 디스크 전반
- **임상 근거**: 동씨침 22부위(수배) 상응 → 허리·하지 전체를 포괄하는 최강 특효혈
- **이 혈자리가 앱에서 빠졌던 이유**: 기존 DB에서 보조 처방으로 잘못 분류되어 있었음 → 수정 완료

**[사암침 배합 1순위] 후계(SI3) + 신관(KD7)**
- 후계(SI3): 건측 사법 — 督脈 교회혈, 척추·요추 직접 주치, 소장-방광 표리 소통
- 신관(KD7): 양측 보법 — 방광경 표리, 기허·신허성 신경통 보강
- **반드시 영골+대백과 병용**: 영골+대백 자침 후 후계+신관 추가 (총 4혈 세트)

**유주별 가감:**
- 엉덩이(둔부)·대퇴 통증 → **견중(77.21)** 건측 추가 (어깨-둔부 상응)
- 오금·종아리 뒤(방광경 라인) 방사통 → **완순1(33.11)+완순2(33.12)** 건측 추가
- 종아리·무릎 아래 저림 → **중백(22.06)+하백(22.07)** 추가
- 노인성·만성 기허 동반 → **비익** 추가, 하삼황(88.17-19) 병용

**방혈**: 환측 위중혈(BL40) 청근 방혈 → 만성·극심 통증 즉효 (반드시 시행)

**사암침 배합**: 방광 정격(상양LI1+지음BL67 보, 삼리ST36+위중BL40 사) 기본; 신허 복합 시 신정격 병용
...
### 요통 사암침 감별
- **방광경 라인 요통** (척추 정중, 요배부): 방광 정격(상양LI1+지음BL67 보, 삼리ST36+위중BL40 사)
- **담경 라인 요통** (측요부, 골반측면): 담 정격(통곡BL66+협계GB43 보, 상양LI1+규음GB44 사)
...
### 불면(不眠) 체질별 사암침
- **태음인(太陰人)**: 담정격(통곡BL66+협계GB43 보, 상양LI1+규음GB44 사)
...
### 골통(骨痛) — 뼈 자체 통증 특효방
- **성혈 조합**: 오호4·5(11.24-25) + 복원(復原) + 통골(通骨) + 소골(消骨) — 이골치골(以骨治骨) 원리
- 복원: "뼈는 복원"이라 불리는 골통 1순위, 뼈에 바짝 붙여 깊게 자침
- 소골: 퇴행성 골자·골격 종대, 뼈 관련 모든 병
- 건측 자침, 골막에 바짝 붙여 심자 — 표면 자침 시 효과 없음
- 사암침: 신주골(腎主骨) 원리 → 신정격; 비습 체질은 태백 사법 (단, 마른 체질 금지)

### 엉치·둔부 통증 심화 (선골/환도 부위)
- **환도혈(GB30) 대응 성혈**: 중백(中白) 건측 — "중백은 환도혈과 직접 대응", 1시간 유침 권장
- 배합: 사화외(四花外) + 신관(腎關) — 장골극(PSIS) 부위 통증 특효
- 완순1·2 + 중백 — 선골(천골) 뻐근함, 방광경 라인 요각통, 여성 신허 복합 필수
- 환도혈 옆통증: 중백+하백+후계 추가
- 앉아 있을 때 통증: 영골·대백 + 정척1·2·3
- 사암침: 방광정격(뒤쪽 무거움), 소장정격(서 있을 때 당김)
- 방혈: 환측 위중혈 청근 방혈 필수

### 발목 불안정·힘 없음 (脚無力 / 발목 꺾임)
- **상백(上白) ★**: 각무력(脚無力) 성혈, 담경상 구허 라인 발목 삐는 것 예방·치료
- **목지(木枝) ★**: 노인성 하지무력 성혈, "지팡이 짚고 들어와 걸어 나감"
- 팔관3·4(八關三·四): 하지무력·퇴연무력 특효, 중풍 후유증 발걸음 장애
- 사암침: **담정격 ★★★** — "평탄한 곳에서도 발목 삘 때" 1순위; 풍륭·광명 보법 병용
- 영골·대백 + 삼차1·2·3: 전신 기력 보강, 보행 강화
- 동기침법: 자침 상태에서 발목 굴신 운동, 제자리걸음 유도

### 발등 통증 (足背痛)
- **오호4(五虎四) ★★★**: 발등 통증 성혈, 발등 염좌·발등뼈 타박 즉효
- **복원(復原) ★★★**: 발등뼈 통증, 무거운 물체 낙하 압박 손상
- 발등 부종+열감: 위정격(胃正格) 또는 신정격
- 사화외 방혈: 어혈 동반 시 발등 부위 방혈 즉효
- 유형별 처방: ①발등뼈 통증=복원+오호4, ②부종·열=위정격, ③단순 염좌=오호4+사화외 방혈, ④신발 압박(충양 부위)=복원

### 완관절(손목) 통증
- **측삼리+측하삼리 ★★★**: 완관절통 최우선 성혈, 어깨~손끝 통증 전체 주치
- **삼중(三重) ★★★**: 손목 시큰거림·저림, 손목 결절종(자갈풍)
- 부위별: ①엄지쪽(양계)=대측 상백, ②새끼손가락쪽(양곡)=대측 곤륜·화주, ③손등 중앙(양지)=대측 구허·삼중
- 손목 염좌: 화주+수천 조합 — "99.9% 치료율"
- 건초염: 양쪽 오호1 + 동기침법; 목두·목류 재발 방지
- 완하수(손목 처짐): 굉중혈, 주먹 쥐기 불능=측삼리·측하삼리 → 열결
- 폐정격: 손목 많이 쓰는 직업성 시큰거림
- 지구+조해 사법: 손목 당기는 통증 즉효

### 전완부 통증 (양곡~기각 라인)
- **삼중(三重) 도마침 ★★★**: 전완부 전체(어깨~손목~손) 통증·마비 — 반대편 다리 삼중혈 동시 자침
- **화관(火串=지구) 사법 ★★★**: 전완 외측(소양경·양명경 라인) 즉각 지통, "대측 취혈 탁월"
- 수오금+수천금: 근육 뭉침·당김 동반 시 반대편 팔 도마침
- 영골·대백: 전신 기혈 소통 베이스

### 협통+견비통 복합 (옆구리+팔 전체)
- **삼중 도마침**: 어깨~손끝 통증 전체 1순위
- **화관(지구) ★**: 옆구리 찌르는 통증(흉통여자) + 팔 기체 동시 해결
- 옆구리 담 결림: 비익(鼻翼) + 옥화(玉火) — "비익·옥화 쓰면 시원하게 끝"
- 사마(駟馬): 폐기 조절, 늑간 압박성 통증
- 간정격: 좌측 옆구리 통증 (간경락 주행), 만성 기울 패턴
- 동기침법: 옆구리 마사지 + 팔 상하 운동 병행

### 고관절(힙조인트) 통증·소리
- **중백(中白) ★★★**: 환도혈(GB30) 대응, 고관절 통증·움직임 시 소리
- **견응(肩凝)**: 고관절·견관절·슬관절 인대 손상 통치
- 관절 마찰음: 폐정격 또는 태백 단독
- 수술 후 통증: **수해(手解) ★★★** — "수술 후 그 자리 아플 때" 1순위
- 수술 후 뼈 회복: 복원+오호+소골+통골 골병 특효방
- 소장정격: 어깨·고관절 회선불리, 수술 후 혈맥 회복
- 방혈: 환측 위중혈 청근

### 상박 통증 (위팔)
- **측삼리+육완(六完) 도마침 ★★★**: 상박 우리한 통증·저림 최우선
- **삼종혈(천종·지종·인종) ★★★**: 혈관질환·동맥경화 동반 상박통, 어깨~상박 광범위 통증
- 신관(腎關): 팔 들기 힘들고 시리며 무거운 상박통
- 측삼리+측하삼리: 삼초경 라인 어깨~손끝 통증·마비

### 하지무력 (각무력·다리에 힘 없음)
- **목지(木枝) ★★★**: 노인성 하지무력 성혈, 단독 즉효
- **상백(上白) ★★★**: 각무력 요혈, 중풍 환자 다리 들어올리기
- 팔관3·4: 퇴연무력, 중풍 하지마비, 아이 보행 장애
- **견중+목지+통천 조합**: "어떤 하지무력에도 다리 힘 생기게 함"
- 영골·대백+삼차3: 전신 기력 + 비신 보익, 동기침법 병행 드라마틱 효과
- 폐정격: 위벽(痿躄) — 근맥 늘어져 걷지 못할 때
- 족삼리 보법 또는 뜸: "한쪽 다리 힘 없을 때" 단혈 처방

### 발가락 3·4·5지 통증
- **속골(束骨) ★★★**: "3·4·5번 발가락 저림·통증 속골 1혈 특효" — 건측 심자
- 오호3(五虎三) ★★★: 발가락 통증 성혈, 뼈에 바짝 붙여 자침
- 소골: 퇴행성 골자·뼈 변형 동반 시 추가
- 팔관3·4: 하지무력·보행 장애 동반 시 추가
- 학정(鶴頂): 노인성 수족 저림·통증 통치
- 목류: 3·4지 사이 통증·굴신 장애 특화
- 하삼황: 저림 심하면 신기 보강 병행

### 양측 무릎 통증 견인침법
- **내관(PC6)+태충(LR3) 양측 견인침법 ★★**: 좌내관 염전→우무릎 운동, 우내관 염전→좌무릎 운동 교대
- 견중+심슬·화슬: 무릎 소리·변형·무력 동반 시 기본방
- 하삼황: 마른 체질·노인성·신허 동반 병행
- 골통 동반: 오호4·5+복원+소골+통골 조합
- 사암침: 폐정격(시큰거림·무력), 방광정격(내측·오금 당김), 비정격(계단 하강통·주위 뭉침)
- 방혈: 사화중·위중 청근 방혈

### 급성 배통 (등 담 들림 / 무거운 물건 후)
- **중자·중선 ★★★**: 등 통증·고황 부위 성혈, 건측 심자
- 정사(正士)+박구(搏球): 양측성·광범위 고황 통증
- 외삼관: 어깨~등 통증, "박하향 나면서 시원하게 낫는 효과"
- 마금수+수통: 척추 옆 방광경 라인 통증, 숨쉴 때 결림
- 비정격: "무거운 것 든 후 어깨·등 통증 및 운동 장애"
- 담정격: 뒷목~등줄기 뻣뻣한 통증
- 동기침법: 건측 중자·중선 자침 후 "등 조금씩 움직여보세요" → 즉석 담 해소
- 방혈: 위중혈 청근 방혈 → 극심·완고 통증

### 구안와사 장기 치료 (4주 이상 완고한 안검 마비)
- **삼중+사화외 환측 방혈 ★★★**: "구급 통치방·기본", 구강 점막 청근도 방혈
- **액문(液門) 사법 ★★★**: "눈 안 감길 때 액문 사법이 아주 좋다" — 해계와 반드시 병용
- 해계+액문+측삼리+측하삼리 건측 자침: 장기 치료 핵심 조합
- 공손+내관 사법: 안검 마비 보조
- 완골 사법: 중추성·완고 마비, 침 끝 반대편 눈 향하게 자입
- 목혈: 눈 안 감기며 눈물 흐름 동반 시 추가 필수
- 족삼리+상거허: 상사자(위 방향) 2촌 이상 심자, 30분~1시간 유침
- 동기침법: 유침 중 눈 깜빡이기 노력 또는 얼굴 근육 마사지

### 마른 체질(수인·피박육소) 자침 원칙
- 천자(淺刺)·불류(不留): 근육 적고 피부 얇은 환자 기본 원칙
- **태백 사법 금지**: "마른 사람은 안 된다" — 비습 체질에만 적합
- **풍시 사법 주의**: "마른 사람은 조심하라" — 강 사법 시 훈침 위험
- 신관+하삼황: 마른 체질 신허 패턴 우선 보강
- 폐정격 미반응 시: 소장정격 합방(폐허+소장허 복합 패턴)
...
- 야간통 심함: 사암 소장정격(임읍GB41+후계SI3 보, 통곡BL66+전곡SI2 사) 병용
...
**[어깨 사암침 병용 감별]**
- 천종혈 압통·어깨 굳음: 소장정격 (임읍GB41+후계SI3 보, 통곡BL66+전곡SI2 사)
- 무겁고 뻐근한 뭉침: 담정격 (통곡BL66+협계GB43 보, 상양LI1+규음GB44 사)
- 밤에 욱신욱신·쑤심: 대장승격 (양곡SI5+양계LI5 보, 통곡BL66+이간LI2 사)
...
### 오장 정격·승격
※ 자침 순서: 타경혈 먼저 → 자경혈 나중 (절대원칙)

- **간정격**: 음곡KD10+곡천LR8(보), 경거LU8+중봉LR4(사) → 간음허·간혈허
- **간승격**: 경거LU8+중봉LR4(보), 소부HT8+행간LR2(사) → 간화상염·간양항진
- **심정격**: 대돈LR1+소충HT9(보), 음곡KD10+소해HT3(사) → 심기허+수기범람
- **심승격**: 음곡KD10+소해HT3(보), 태백SP3+신문HT7(사) → 심음허+담음
- **심포정격**: 대돈LR1+중충PC9(보), 음곡KD10+곡택PC3(사) → 심포기허+수기
- **심포승격**: 음곡KD10+곡택PC3(보), 공손SP4+내관PC6(사) → 심포음허+담음
- **비정격**: 소부HT8+대도SP2(보), 대돈LR1+은백SP1(사) → 비기울체+중초양기부족
- **비승격**: 대돈LR1+은백SP1(보), 경거LU8+상구SP5(사) → 수습정체·부종
- **폐정격**: 태백SP3+태연LU9(보), 소부HT8+어제LU10(사) → 폐기허(폐열로 인한)
- **폐승격**: 소부HT8+어제LU10(보), 음곡KD10+척택LU5(사) → 폐양부족+수기상승
- **신정격**: 경거LU8+부류KD7(보), 태백SP3+태계KD3(사) → 신음허+납기불능
- **신승격**: 태백SP3+태계KD3(보), 대돈LR1+용천KD1(사) → 신정·신기고갈

### 육부 정격·승격
※ 자침 순서: 타경혈 먼저 → 자경혈 나중 (절대원칙)

- **위정격**: 양곡SI5+해계ST41(보), 임읍GB41+함곡ST43(사) → 식적+위한증+근골격질환
- **위승격**: 임읍GB41+함곡ST43(보), 상양LI1+여태ST45(사) → 위장무력이완+부종종창
- **소장정격**: 임읍GB41+후계SI3(보), 통곡BL66+전곡SI2(사) → 독맥양기촉발+소장실열
- **소장승격**: 통곡BL66+전곡SI2(보), 삼리ST36+하거허ST39(사) → 소장열+역기강하
- **대장정격**: 삼리ST36+곡지LI11(보), 양곡SI5+양계LI5(사) → 진액흡수+조열(탁효) ※조열·습열 모두 치료
- **대장승격**: 양곡SI5+양계LI5(보), 통곡BL66+이간LI2(사) → 대장한증·염증치료
- **방광정격**: 상양LI1+지음BL67(보), 삼리ST36+위중BL40(사) → 습배출+위기강화(피부기부)
- **방광승격**: 삼리ST36+위중BL40(보), 임읍GB41+속골BL65(사) → 방광경라인뻐근당김
- **삼초정격**: 임읍GB41+중저TH3(보), 통곡BL66+액문TH2(사) → 삼초근골격+염증통증
- **삼초승격**: 통곡BL66+액문TH2(보), 삼리ST36+천정TH10(사) → 삼초허열+역기강하
- **담정격**: 통곡BL66+협계GB43(보), 상양LI1+규음GB44(사) → 담음허+풍열습
- **담승격**: 상양LI1+규음GB44(보), 양곡SI5+양보GB38(사) → 담화상염
...
## 실전 Q&A 임상 처방 심화 (Guide2 보강편)

### 수지마(手指麻) — 손 저림 처방 체계
- **신관(腎關)+부류(KD7) ★★★**: "손 저림의 극특효방" — 신관은 음릉천 하 1.5촌
- **학정(鶴頂) 또는 학정 대응점**: 열 손가락 저림(十指麻木) 특효
- 삼중(77.07-09): 전완부~수지 저림 전반
- 사암: 심포정격(수전 저림), 삼초정격(외측저림), 주담방(음주 후 저림)

### 요추수술 후(철심 고정) 통증 처방
- **수해(手解)+복원+소골+통골+오호(11.27) ★★★**: 수술 후 잔존 통증 1순위
- 정척1·2·3: 수술 부위 척추 분절 직접 자극
- 정근+정종: 아킬레스건~뒷머리 라인 후면 경직 해소
- 사암: 대장승격(욱신욱신 야간통 강), 방광정격(후면 하중감)

### 발바닥 서주감(벌레 기어가는 느낌)
- **태충+광명 직자 ★★★**: 건측, 두 혈 도마침
- 음곡보+대돈사 건측 병용
- 사암: 폐정격(피부감각 이상), 소장정격(작열·서주 즉효)
- 노궁사: 발바닥 열감+서주 동반 시 추가

### 30대 불면증 처방
- **진정(111)+심령1·2·3+상삼황(명황·천황·기황) ★★★**: 실면 표준 기본방
- 실면혈(발뒤꿈치 바닥 중앙 3분 자침): 즉효
- 안면1·2(예풍~풍지 사이): 피내침 유치
- 사암: 담정격(불안·잘 놀람), 심정격(가슴 두근거림), 비정격(사려과다·생각 많음)
- 조해보+신맥사: 음교맥 조절, 야간 각성 억제

### 고혈압+하복통 복합 처방
- **화경(火硬, 66.08) 염전 ★★★**: "염전만으로 혈압 100mmHg 이상 즉시 하강"
- 화경+문금: 혈압조절+하복통 동시 해결
- 완순1·2: 신허형 고혈압 기저 보강
- 간문+곡릉 하사자: 간화성 고혈압 복통
- 사암: 방광정격(후면 하중 동반), 간정격(옆구리 통증 동반)
- 방혈: 후두구(後頭丘)+오령혈 방혈 — 혈압 급강하

### 마른 체질 어깨 통증 처방
- **견중(77.21) ★★★**: "마른 사람은 견중이 주혈" — 심자 불가, 천자 원칙
- 신관(88.14): 여성=남좌여우 원칙으로 주측 결정
- 사암: 담정격("날씬한 사람 류마티스=담정격"), **풍시 사법 금기** (훈침 위험)
- 태백 사법 절대 금지

### 비만 습체질 귀뒤~어깨(태양혈-후두-어깨 일직선) 견비통
- **족천금(119)+족오금(120) ★★★**: "태양혈-뒷머리-어깨 일직선 통증 끝내줌"
- 풍시 사법: 비습 체질 어깨 통증 특효 (비만+습 체질에만 적용)
- 신관+비승격: 습담 체질 기저 치료
- 방혈: 척택(LU5) 청근 방혈 필수

### 코막힘 처방 (마른 체질 40대 남성)
- **견중+측삼리 ★★★**: "1침으로 코 즉시 통함" — 수족 상응(어깨=코 부위)
- 목혈(007): 기본 비류청체
- 사마상중하: 폐경 전반 조절
- **사마중 방혈 ★★★**: "양쪽 코 확 뚫린다" — 압통 확인 후 방혈
- 정본(소료) 방혈: 비강 점막 울혈 해소

### 좌골신경통+전기감전 느낌(찌릿)
- **대릉(PC7)+내관(PC6)+간사(PC5) ★★★**: "찌릿한 전기감전 증상에 탁월"
- 영골·대백: 기본 좌골신경통 베이스
- 노궁사: 심포경 화열 소통
- **골관+목관(44.01·44.02) ★★★**: 족근통+좌골신경통 복합 특효

### 생리 중 귀뒤~어깨 통증 (38세 여성)
- **족천금+족오금+문금(文金) ★★★**: "생리 기간에 문금 먼저 자침" — 어혈 소통 선행
- **문금혈 위치**: 제2·3중족골 기저 오목처 (함곡혈 부위), 직자 0.5~1.5촌, 단측 원칙
- 부과+환소: 여성 생리통 기저 처방
- 옥화(180): 생리 중 요각통 혈어 패턴
- 임읍: 소양경 측두~어깨 통증 보조

### 족천금·족오금 위치 (임상 기준점)
- **족천금(119)**: 측하삼리 직하 2촌 후방 5분 — 직자 0.5~1촌
- **족오금(120)**: 족천금 직하 2촌 — 직자 0.5~1촌
- 두 혈 항상 도마침, 태양혈-어깨-후두부 일직선 통증 통치

### 심슬·화슬·심문 위치
- **심슬(009)**: 중지 제2절 양측 적백육제, 직자 1~3푼
- **화슬(018)**: 소택혈 후 1~2푼, 직자 1~2푼 — 심장+류마티스 무릎
- **심문(心門, 056)**: 전완 척골 주첨하 1.5촌 함몰처, 4~7푼 심자 — SCM통·미골통·사타구니통 특효

### 남성 무릎 통증 처방 감별
- 견중+심슬·화슬: 무릎 전반, 심장 기능 약화 동반 패턴
- 내관+태충 견인침법: 좌내관 염전→우무릎 운동, 우내관 염전→좌무릎 운동 교대
- 무릎 내측=심문+화경, 외측=담혈(66.13)
- 오금 땡김=중자·중선, 계단=통천(125)/비정격
- 사암: 방광정격(내측 100% 효과), 폐정격(시큰거림·마찰음)

### 좌골신경통+서혜부(사타구니) 복합 처방
- **심문(056) ★★★**: "사타구니 통증 성혈" — 주첨하 1.5촌 심자
- 영골+태충 견인침법: 건측 영골 자침+환측 태충 추가
- 사암: 간정격("아랫배와 사타구니는 모두 간") — 간허형 기본
- 방혈: 위중+금림(金林) 환측 방혈

### 구안와사 10회 이상 완고형
- **삼중·사화외 방혈 먼저 ★★★**: "삼중·사화외 방혈 먼저 하고 생각하라"
- 해계사+액문사+완골사(GB12): 완고 안면마비 3대 사법 조합
- 인중·승장 작탁: 입 뒤틀림 즉효
- 위승한격+함곡: 신경성 경직 해소
- 구강내 청근 방혈: 10회 이상 완고례 필수

### 어지럼증 처방 감별 (30대)
- **통관+통산+통천 ★★★**: 뇌빈혈성 어지럼증 — 세 혈 도마침
- **신관(88.14) 단독 ★★★**: "30초 이내 즉효" — 신허형 현훈 1순위
- 비익(179): 평형감각 상실형
- 사암: 비정격(스트레스성), 간승격(간화상염형), 담훈방

### 70대 노인 요통 심화 처방
- **후추+수영 ★★★**: "앉았다 일어설 때 힘겨움" 특효, 도마침
- 영골·대백+중백: 기력+좌골 기본 조합
- **오호+복원 ★★★**: "구부정한 허리 한 번에 펴는" — 골막에 바짝 붙여 심자
- 마금수+마쾌수: 요안통(허리 안쪽 통증)
- 수금+수통: 신장 기력 보강
- 방혈: 환측 위중 청근 방혈
- 정력 병행 요청 시: 하삼황(신관+지황+인황) 양측 추가, 대돈(LV1) 추가

### 발바닥 통증 처방 (근육질 남성)
- **노궁사+화골1(花骨一) ★★★**: "발바닥 특효"
- 영골·대백: 폐기 통기 보조
- 사암: 신정격("족저근막염=신정격으로 바로 호전")
- 오호3·4·5 도마침: 발가락~발바닥~뒤꿈치 전체 커버

### 액문 사법 자침요령
- **직자=사법**, 중저 방향 사자=보법 구분
- 응급 졸도 시=양지(SJ4) 방향 피하자침 — 즉시 소생
- 눈 안 감길 때는 해계와 반드시 병용

### 정력 강화 동씨침 처방
- **하삼황(신관+지황+인황) ★★★**: 보신 강장 1순위, 양측 자침+저주파 전침 30분
- 대돈(LV1) ★★★: 발기부전(양위) 특효, 간주근(宗筋) 원리, 남좌여우 원칙
- 사암 정력방: 음릉천+누곡+삼음교 직자 (비경 우측 위주)
- 완순1(034): 신허 정액결핍·신허요통 보조

### 70대 여성 새벽 쥐(근육경련) 처방
- 사암: **간정격 ★★★** — "새벽이나 아침에 쥐날 때" 특효, 간주근(肝主筋) 원리
- 담정격: 일체 근육 긴장·경련 통치
- 동씨침: **정근+차백(次白) ★★★** — 하지 쥐 정석 (건측)
- **목지(木枝) ★★★**: 노인 하지무력+쥐 동시 해결
- 화포(火包) 방혈: 환측 — 즉석 근육 이완
- 승산 사혈: 전통 보조 요법

### 발뒤꿈치 통증 심화 (토수혈 포함)
- **소절(小節) ★★★**: 발목 통증 최고 명혈 — 대릉 방향 뼈막 타고 1~1.5촌 자입
- **오호5(11.27) ★★★**: 발뒤꿈치 전용
- **토수(土水) ★★**: 엄지손가락 제1중수골 안쪽 어제 부위 3혈 — 족근통에 심자
- 골관+목관: 뼈=골관, 근육=목관 감별
- 정근+정종: 아킬레스건 후면 경직
- 소상(LU11) 방혈(대측): 족근통 즉효
- 위중 방혈(환측): 하지 어혈 제거

### 발목 통증+신결석+태소양병 복합 처방
- 발목 내측 상단: **소절 ★★★** (대릉 방향 심자) + 견중 + 오호4·5
- 신결석: **마금수(181)+마쾌수(182) 도마침 ★★★** — 통증 즉시 소실, 소석 배출 촉진
- 수유혈: 신결석 요통+전신무력 방혈 또는 자침
- 태소양병: 담정격+지구사 — 소양경 화기 제거

### 오십견 거상불능 처방 (좌측 어깨)
- **신관(88.14) ★★★**: 거상불능 1순위 (우측 건측 자침)
- 화골2(花骨二): "수비불거에 아주 좋다" — 발바닥 특효혈
- 방혈: **척택(LU5) 환측 방혈 ★★★** — "심한 동결견 꼭 사혈", 즉시 거상 가능
- 사화중 방혈: 어깨 응결 해소
- 회전불리: 족천금+족오금 추가
- 어깨~손끝 저림: 삼중(77.07-09) 추가

### 허리 가운데+힙사이드 통증 복합 (40대 남성)
- 허리 중앙(독맥/방광경): 정근+정종 + 영골·대백
- 폐심(022): 척추 중앙 라인+꼬리뼈 통증
- 힙사이드(소양경): **중백·하백 ★★★** + 견중·운백·상곡
- 사암: 담정격(힙 사이드 근육 긴장)
- 방혈: 위중 환측 방혈 우선

### 수술 5년 경과 만성 무릎 통증
- **복원(013) ★★★**: "외상·수술 후 치료 안 되고 남은 것" — 골막에 바짝 심자
- 소골(消骨) ★★: 수술 후 뼈 자체 통증, 경골 외연 뼈막 자침
- 견중: 기본 무릎 통증 베이스
- 방혈: **위중 환측 ★★★** + 삼금(三金) 방혈(오래된 슬통)
- 사암: 방광정격(내측 100%), 폐정격(시큰거림)
- 동기침법: 무릎 굽혔다 폈다

### 외상 후유증(4개월 발목) 처방
- 소절+오호4+복원: 기본 조합 (좌측 건측)
- **내양구(ST34)+음릉천(SP9) ★★★**: 사암 — "외부 타박·강판에 눌린 모든 손상 특효"
- 폐정격: 마찰음+시큰거림 동반 시
- 위중 방혈: 4개월 묵은 어혈 제거
- 동기침법 필수: 발목 돌리기

### 엄지손가락 인대 손상 처방
- **해표(海豹) ★★★**: "무지 삐었거나 아픈 모든 것 = 해표" — 엄지발가락 안쪽 적백육제
- 오호1(11.27): 엄지손가락 건초염·근육손상
- 어제(魚際)/토수: 무지구 통증·저림
- 사암: 내양구+음릉천 — 외상 모든 조직손상
- 어혈방(태백·태연 보, 곡지 사): 멍+고정통 동반 시

### 간 문제 동반 어깨 통증
- **행간상 1촌 (화경 상 5푼) ★★★**: "목·어깨가 간으로 인한 경우" — 상사자 최대 심자
- **상삼황(명황·천황·기황) ★★★**: 간염·간경화 동반 어깨통 핵심
- 간문(033.13): 입 쓰고 어깨 무거울 때 즉반응
- 신관+견중: 어깨 보조혈
- 사암: 간정격(과로·간혈허), 담정격(무겁고 뭉침)

### 경항통(목+뒷덜미) 완전 처방
- 통치방: **인중+승장 직자 + 후계/속골 배합 + 폐심+중자·중선**
- 전굴제한=승장 심자, 신전제한=인중 심자
- 좌우 회전제한: 후계 또는 상백
- 흉쇄유돌근(SCM) 통증: **심문(056) 단독 ★★★**
- 목 디스크: 정척1·2·3+폐심+삼하
- 방혈: 충소(후두통) + 이배(목 뻣뻣+충혈) + 위중(후면 전체)
- 사암: 담정격(쇳덩이처럼 무거움), 대장정격(극심·뼈 부러지는 느낌)

### 발바닥 이상감각+열감 처방 (50대 여성)
- **하삼황+노궁사+화골1 ★★★**: 기본 조합 (좌측 건측)
- 소장정격: "살갗에 벌레 기어다니는 느낌(피풍)" 즉효
- 방광정격: 발뒤꿈치 쪽 열감+무거움
- 신정격: 중족골 통증+신허 작열
- 방혈: 위중 환측(열감+부종 심할 때)

### 태소양병 구안와사 처방
- 방혈 1순위: **삼중+사화외 환측 방혈 ★★★** + 구강 점막 청근 방혈
- 건측 주혈: 측삼리+측하삼리+풍시 심자(머리 방향)
- 눈꺼풀 마비: 건측 해계사 필수
- 얼굴 뻣뻣: 건측 완골사(반대편 눈 방향 심자)
- 입 마비: 삼천 또는 인중·승장 작탁
- 사암: 담정격(소양경 화기), 삼초정격(눈썹 주위 통증)
- 동기침법: 얼굴 근육 계속 움직이게

### 사화부(四花副)·삼중(三重) 위치 정리 (임상 참조)
- 수직 위치(무릎 기준): 사화중·사화외(7.5촌) > 삼중 세트 중 삼중(9촌) > 사화부(10촌)
- **삼중**: 외과첨 상 3촌 앞 1촌(일중)~7촌(삼중), 담경-위경 중간 라인
- **사화외**: 사화중(무릎 하 7.5촌)에서 외측 1.5촌 — 풍륭(ST40) 유사 위치
- 소퇴양명구 전체를 '심폐구(心肺區)'로 보고 가장 뚜렷한 청근 방혈이 핵심

### 10년 된 외상 후 어깨 통증
- **복원(013) ★★★**: 10년 묵은 외상 후유증 복원혈 필수
- 신관+견중: 어깨 기능 복구
- **대장승격 ★★★**: "10년 전 타박 어깨 통증" 직접 적응증
- 어혈방: 태백·태연 보, 곡지 사
- 방혈: 척택 환측 방혈(동결견 10년+)

### 팔뚝 통증 처방 (아래팔/위팔)
- **아래팔(전완) 통증**: 화곶(지구, TE6) 건측 + 삼중 도마침
- **위팔(상박) 통증**: 측삼리+육완(六完) 도마침 ★★★ + 신관
- 팔 전체 저림+통증: 삼중(77.07-09) 전반
- 영골·대백: 상지 통증 기본 베이스
- 방혈: 척택 청근(만성·구병)

### 허리 전굴 곤란 처방
- **영골·대백+삼차(차삼) ★★★**: 전굴 제한 베이스
- 사봉1(四縫一): "허리를 앞으로 굽힐 수 없을 때" 특효혈
- 이각명: 급성 요안통+전굴 곤란
- 사암: 방광정격(방광 1선 당기며 굽히기 힘듦)
- 관충사: 지실 부근 통증으로 굽히기 힘들 때
- 방혈: 위중 환측 필수

### 60대 여성 태소양병 무릎 통증
- 사암: **담정격 ★★★** (소양경 무릎 외측+근육 긴장)
- 소부사: 60대 여성 퇴행성 전신 관절통
- 동씨침: 견중 기본 베이스 + 화슬·심슬(심장 동반)
- 내관+태충 견인침법: 무릎 통증 즉효
- 방혈: 위중 환측 + 삼금(오래된 슬통)

### 불면 처방 공통혈 정리
- **진정(111)+실면혈+하삼황 ★★★**: 불면 통치 기본조합
- 진정(인당 상 3분): 뇌중추신경 안정
- 실면혈: 발뒤꿈치 바닥 중앙, 단측 3분 자침
- 안면1·2: 피내침 유치
- 심령1·2·3: 부정맥 동반 불면
- 상삼황: 정신 긴장형 소요산 효과
- 사암: 담정격(심담허겁), 심정격(마음 허전), 비정격(사려과다), 삼초정격(스트레스)

### 태소양병 1년 항강통+견배통+고황통
- 고황통: **중자·중선 ★★★** (단배통 특효) / 정사·박구 (쌍배통+외상성)
- 항강통: 정근+정종 (뒷목 뻣뻣) + 상백 (목 디스크 동반)
- 사암: 담정격+지구사 (태소양병 소양경 화기)
- 방혈: 위중(인체 후면 전체) + 충소(후두통 고황)
- 1년 구병: 방혈 필수 — 침만으로 부족

### 좌측 발뒤꿈치~좌골신경통 복합 처방
- 영골·대백+중백·하백: 좌골신경통 기본 조합 (우측 건측)
- **오호5+골관·목관 ★★★**: 발뒤꿈치 추가 (뼈=골관, 근육=목관)
- 정근+정종: 아킬레스건~뒷머리 후면 라인
- 비익: 기허성 만성 좌골신경통 보조
- 방혈: 좌측 위중 청근 방혈 1순위
- 견인침법: 방광경 라인→속골, 담경 라인→임읍 추가

### 불안증 처방
- **진정+심령 ★★★**: 모든 심리·정신 질환 공통 안정혈
- 신관+화경+지종+담혈: 심장신경증·자율신경실조증·불안증
- 양부족형 불안: 풍시+심문(056)+곤륜 — 심장 박동 강화로 안정
- 대릉(PC7): 신경성 불안·불면·정신병 중심혈
- 사암: 담정격(잘 놀람), 심정격(마음 허전), 삼초정격(스트레스)

## 실전 Q&A 임상 처방 심화 (Guide2 보강편 2)
...
- 대인기피, 수줍음 → 신정격
- 고소공포증 → 방광정격
- 배부 심폐구(배수혈 영역) 방혈 + 상삼황 병행

### 우측 귀뒤~팔 통증 (수소양삼초경)
- 건측(좌) 측삼리·측하삼리, 삼중, 중자·중선
- 삼초정격, 지구 사
- 이배·삼중 방혈
...
### 구안와사 (안면마비)
- ★★★ 필수: 환측 삼중·사화외 방혈 가장 먼저 시행
- 건측: 측삼리·측하삼리·삼천
- 해계 사(눈 처짐), 인중·승장(입 비뚤어짐), 완골 사(근육 굳음)
- 사암: 위승한격(실증), 담정격
- 회복 징후: 서주감(시큰한 느낌) → 5일 이내 완치 기대
...
### 20대 소양병 (구고+좌협통+명치+변비)
- 간정격, 목염·간문
- 심정격 + 화포
- 대장정격, 기문·기각·기정
- 방혈: 상양
- 처방: 시호계지탕 (소양증 적합, 대황 가감 필요)
...
### 중구리 위치
- 무릎 위 7촌, 대퇴 외측
- 차렷 자세에서 중지 끝이 닿는 위치 (풍시)

### 마른 체질 남성 무릎 안쪽 통증
- ★★★ 심문 (뼈에 붙여 자침)
- 화경·화주
- 사암: 방광정격(압통), 폐정격(시큰), 족삼리 사(마른 사람)
- ★ 태백 사 = 마른 사람 금기
...
- 완순1·2(신허 이명 + 후두통)
- 삼중
- 사암: 방광정격(후두통+이명), 신정격, 담정격
- 방혈: 삼중·사화외·태양·이배

### 30대 여성 붕루+혈전
- 지혈: 상양·지음·삼음교 보 + 대돈·은백 뜸
- 어혈방
- 부과·환소 (부인과)
- 보침 = 녹용침

### 60대 여성 팔 트위스트 (비틀리는 통증)
- ★★★ 척택 사
- 굉중
- 간정격
- 내양구·음릉천, 어혈방
...
### 43세 남성 손발가락 저림 + 간염 (건장체질)
- ★★★ 학정
- 통관·통산(손 저림), 통천(발 저림)
- 신관·부류
- ★★★ 상삼황
- 간문·장문 도마침(GOT/GPT 하강)
- 목염
- ★★★ 풍시 사 (비습 건장 체질)
- 분지상하 (독소 해독)

### 삼황혈 위치 구분 (핵심)
- **상삼황** = 명황·천황·기황 (누를 황黃, 대퇴 내측 간경, 내전근 선상)
  - 명황 = 무릎 내측 중앙~서혜부 내측 중점
  - 천황 = 명황 직상 3촌
  - 기황 = 명황 직하 3촌
  - 심자 1.5~2.5촌
- **하삼황** = 천황·지황·인황 (임금 황皇, 소퇴 내측 신장)
  - 천황 = 음릉천 (내과 상 13촌)
  - 지황 = 내과 상 7촌
  - 인황 = 삼음교 (내과 상 3촌)
  - 천황~지황 = 6촌 간격

### 70대 남성 양쪽 고관절+하지통증 (태소양병)
- 중백·중저·후계 (골반 근육 이완)
- 견중·운백·상곡 (이상근~좌골)
- 수곡 (70대 담경 좌골)
- 정근·정종
...
- 영골 + 환측 태충★★★
- ★★★ 심문·신문
- 4자 자세 안 되면: 심문+중간+대간+오호5
- 경락별 견인 적용

### 교차자침 조합
- 영골·대백(한쪽) + 후계·신맥(반대) = 훌륭한 조합
- 매 시술마다 좌우 번갈아 자침

### 50대 남성 발바닥 서주감
- 태충 + 광명 + 음곡 보 + 대돈 사★★★
- 사암: 폐정격(피부 무감각), 심정격(살 속 벌레 기는 느낌)
- ★★★ 노궁 사

### 남성 다이어트
- ★★★ 화국 (비만 최고 + 남성 생식기)
- 수곡·중백
- 임읍·함곡 보 / 해계·양계 사 + 이간 보 (10회 5kg)

### 여드름 처방
- ★★★ 사마 + 영향
- ★★★ 이배 방혈
- 내정 사 (위열)
- 뺨: 위승격·담정격 / 입 주위: 신정격 / 이마: 방광정격
- 부과·환소 (여성)

### 50대 남성 좌측 팔꿈치 태소양 복합
- 태양경: ★★★ 곤륜 사, ★★★ 심문+후계 견합
- 소양경: 지구 사, 삼중
- 통합 처방: ★★★ 영골 + 풍시 견인
...
### 통관·통천 vs 통신·통위 vs 신관 구분
- 통관·통천 = 대퇴 전면 위경 (심장, 혈압 올림, **양측 동시 금지**)
- 통신·통위 = 대퇴 내측 비경 (신장, 부종)
- 신관 = 종아리 안쪽 (보신 강장)
...
- 음주 만성경항통 → 상삼황 양측
- 낙침(급성) → 행간 상1촌 상사자
- 경추 디스크 저림 → 정척1,2,3 + 폐심 + 삼하, 상백

### 속골 위치
- 제5중족골 외측 (새끼발가락 뿌리 뒤 오목)
- 뼈 밑 수평 자입
- 적응: 목 전후 가동, 후두통, 요통
...
## 실전 Q&A 임상 처방 심화 (Guide2 보강편 3)

### 발목·발 처방 심화

**소절혈 위치·자침법**
- 위치: 대릉(심포3) 방향으로 직자 → 사실상 사자(斜刺)
- 적응증: 발목 통증, 발뒤꿈치 통증 ★★★
- 배합: 오호4→소절 순서

**발목염좌 완치 처방**
- 영골·수천(대백 직하 1.5촌, 중백 하 1촌) → 발목염좌 99.9% ★★★
- 오호5(새끼발가락 손톱 외측 0.1촌) → 발뒤꿈치 통증 ★★★
- 오호4+오호5 도마 배합 가능

**발바닥·종아리 처방**
- 차백(차뒤꿈치 외측 2촌) → 종아리 통증 ★★★
- 노궁 사(瀉, 사자 1~1.5촌) → 발바닥 통증 ★★★
- 복원혈(중배수-중완 근방) → 골격통 기본 처방 ★★★

**아킬레스건·발뒤꿈치 처방**
- 정근(어제 상 1.5촌)·정종(어제 상 2.5촌) + 실면 → 아킬레스건 통증
- 상류혈: 뒤꿈치 굳은살 앞경계 정중앙, 3~5분 자침 → 뇌압, 발뒤꿈치 굳은살
- 골관·목관+복원 → 발목관절 구조 이상
...
**신관·부류 실패 시 대처**
- 신관·부류로 효과 없는 경우 → 학정혈(足跟, 발뒤꿈치 중앙) ★★★ + 염전(捻轉)자극
- 학정 = 발뒤꿈치 바닥 정중앙 (실면혈과 위치 유사)

**수오금·수천금 위치**
- 수오금: 완횡문 상 6.5촌, 척골 외측(외관 상방)
- 수천금: 수오금 직상 1.5촌
- 도마 배합 → 경항, 흉협통

**수무흉 취혈 자세**
- 자침 시 손을 가슴 위에 올린 자세에서 취혈

### 어깨 처방 심화

**내슬안(內膝眼) 자침법**
- 깊은 직자(深刺) → 어깨 안쪽 통증, 태소양(太少陽) 어깨 ★★★
- 외슬안도 병행 가능

**풍융+후계·중저 견인법**
- 풍융(비위경 낙혈) + 후계(소장경)·중저(삼초경) 견인 ★★★
- 적응: 어깨 올리기 어려운 통증

**곤륜 직자(곤륜 자침 → 중부·운문 어깨 치료)**
- 곤륜(방광62) 직자 1~1.5촌 → 중부·운문 부위 어깨 통증 ★★★
- 태양경→태음경 교경 원리

**척택 방혈(어깨 실증)**
- 척택(폐5) 청근 방혈 → 실증 어깨 통증 즉효 ★★★
- 시술 전 팔을 굽혀 청근 확인 필수

**족천금·족오금+수곡 견인**
- 족천금(곤륜 상 3촌)·족오금(족천금 상 1.5촌) + 수곡(담원혈) 견인
- 어깨 측면·후면 통증

**견통혈(평형침법)**
- 위치: 이첨 직하 1.5촌 (내 귀 바로 아래)
- 적응: 어깨 전반 통증 (평형침법 특효혈)

### 경항통 처방 심화

**중자·중선+승장 견인**
- 중자(中渚 유사, 4지3절사이) + 중선(中渚 상) + 승장(任24) 견인 ★★★
- 경항통 가장 강력한 처방 중 하나

**정근·정종 (경항통 성혈)**
- 위치: 어제 상 1.5촌(정근), 2.5촌(정종)
- 경항통·낙침 ★★★
...
**상백(上白)**
- 위치: 합곡 상 1.5촌 (제2중수골 요측)
- 경항통 ★★★

**방혈: 이배·위중**
- 이배(耳背) 청근 방혈 → 경항 급성 통증
- 위중(방광40) 청근 방혈 → 만성 경항·요통

### 두통·고혈압 처방 심화

**오령혈(五嶺穴) 방혈**
- 위치: 독맥 대추(GV14) 양옆 각 1.5촌, 상하 5개 포인트
- 방혈 → 두통, 고혈압, 뇌압 ★★★

**삼성혈(三星穴)**
- 위치: 용천(신1) 뒤 1촌·2촌·3촌 3개
- 두통, 뇌압 상승, 불면
...
**고혈압 주의사항**
- 통천혈(방광7): 고혈압 환자에게 전체(양측) 자침 금지, 1혈만 사용
- 고혈압혈 = 족삼리 하 1.5촌 (평형침법 특효혈)

### 부인과·불임 처방 심화

**부과·환소 교자 격일 처방**
- 부과(婦科, 대지1절 요측손등): 자궁, 난소
- 환소(還巢, 약지2절 손바닥면): 난소, 불임
- 교대로 격일 자침 → 불임, 월경불순 ★★★

**착상 보조 처방**
- 봉소(蜂巢)·황소(皇巢) + 부과 + 상삼황(천황·명황·지황)
- 소장정격(소장을 강하게) → 착상 보조 ★★★

**자궁 청근 방혈**
- 내과(내과 하 1촌) ~ 삼음교 구간 청근 방혈
- 자궁 어혈, 생리통, 불임 치료

**임신 안태 처방**
- 통신(通腎)·통위(通胃) 각 15일 자침 → 안태(安胎)

### 불면 처방 심화

**불면 기본 처방**
- 진정(鎭靜, 새끼손가락2절 손등 요측) + 하삼황(천황·명황·지황) + 실면 ★★★

**습담 불면**
- 경거(肺8) 사(瀉) → 습담으로 인한 불면 ★★★
...
**기허 불면**
- 영골·대백 + 진정 + 실면 → 기허(氣虛)로 인한 불면 ★★★

### 변비 처방 심화

**기문·기각·기정 연피자(沿皮刺)**
- 기문(奇門, 대지 손톱 내측 0.1촌 상방)
- 기각(奇角, 기문 상 1촌)
- 기정(奇正, 식지 손톱 내측 0.1촌)
- 3개 연피자 → 2시간 이내 배변 ★★★
...
**지구(支溝, 삼초6)·조해(照海, 신6) 사(瀉)**
- 변비 기본 처방

### 구안와사 처방 심화

**삼중·사화외 방혈 선처치**
- 삼중(三重): 외과 상 3·6·9촌 3개 혈
- 사화외(四花外, 담경 외과 상 7촌 방)
- 방혈 먼저 시행 후 자침 ★★★
...
**화경·화주+액문 처방 (화(火) 후 구안와사)**
- 화(熱)로 발생한 구안와사 → 화경(火經, 소지2절 손등)·화주(화경 상) + 액문(삼초2) 사 ★★★

### 전신통·좌골신경통 처방 심화

**전신통 기본 처방**
- 사지(四肢, 내과 상 4촌 = 삼음교+1촌) + 삼음교 + 영골·대백 ★★★

**비익혈(臂翼穴, 만성 전신통 필수)**
- 위치: 소상(폐11) 상방 1촌 (엄지 요측 손등)
- 만성 전신통, 면역 강화 ★★★

**금림구역(金林區域) 방혈**
- 위치: T4-T6 척추 양옆 6촌 구역
- 방혈 → 전신통, 흉배통 ★★★
...
**사신열(四神熱) 자음 처방**
- 완순1·2 → 인슐린 분비 촉진, 자음(滋陰) ★★★

**하삼황 (당뇨 성혈)**
- 천황·명황·지황 → 당뇨 특효 ★★★

**지사마(止瀉馬, 설사 정지)**
- 위치: 식지 2절 손등, 4등분 3개 점
- 설사, 장염 즉효

**목혈(木穴, 피부소양)**
- 위치: 식지 1절 손바닥, D선 3등분 2개 점
- 피부소양증, 건조 피부 ★★★

### 복합 증상 처방 심화

**도한·자한(盜汗·自汗) 처방**
- 지한(止汗)·명황(明黃)·사마중(四馬中)·신관(腎關) ★★★

**소화+가슴 답답함 처방**
- 간문(肝門)·심문(心門) 도마 → 간 담 소화 + 흉비 ★★★

**부종+소화 처방**
- 통신(通腎)·통위(通胃)·통배(通背)·통천(通天) ★★★

**만성 헛구역질 처방**
- 천황(天黃)·신관(腎關) → 5년 된 헛구역질 치료 ★★★

### 정혈 위치 총정리 (보강)

| 혈명 | 위치 | 적응증 |
|------|------|--------|
| 사지(四肢) | 내과 상 4촌 (삼음교+1촌) | 전신통 |
| 상류(上瘤) | 뒤꿈치 굳은살 앞경계 정중앙 | 뇌압, 뒤꿈치 굳은살 |
| 실면(失眠) | 뒤꿈치 바닥 정중앙 | 불면 특효 |
| 심령1(心靈1) | 대릉 상 1.5촌 | 심계, 손목 |
| 심령2(心靈2) | 대릉 상 2.5촌 | 심계, 손목 |
| 심령3(心靈3) | 대릉 상 3.5촌 | 심계, 손목 |
| 내화슬(內花膝) | 새끼손가락 2절 안쪽 | 무릎 내측 |
| 환소(還巢) | 약지 2절 손바닥면 | 난소, 불임 |
| 지신(止腎) | 약지 1절 손등 3개 | 신장 |
| 학정(鶴頂) | 발뒤꿈치 중앙 | 신관·부류 실패 시 대체 |
| 고혈압혈 | 족삼리 하 1.5촌 | 고혈압 |
| 견통혈(肩痛穴) | 이첨 직하 1.5촌 | 어깨 통증 |

## 실전 Q&A 임상 처방 심화 (Guide2 보강편 4 — 최종)

### 전신통 추가 처방 상세

**몸살·외감 전신통**
- 사지혈(내과 상 4촌) + 삼음교 상사자(上斜刺) → 즉효 ★★★
- 가감: 통관·통산 추가 → 감기 몸살 후 사지 저림·통증

**일체 전신통 강력 지통**
- 수해혈(手解穴 = 소부혈, 心8) → 원인·부위 무관 즉효 ★★★
- 배합: 임읍·중구리 추가 가능

**유주성·원인불명 전신통**
- 상구리·중구리·하구리(삼구리혈) → 인체 측면 기혈 소통 ★★★

**비습 체질 전신통**
- 풍시혈(중구리) 심자(深刺, 골막 닿을 정도) 사법 → 비만·습담 전신통

**류마티스 관절 전신통**
- 견중 + 건중 + 통관 + 통천 + 신관 → 다발성 관절통, 유주성 풍습

**전신 골종·골격 통증**
- 복원 + 오호 + 상삼황 → 뼈마디 결절, 약물성 골종 ★★★

**이완성 전신통 (기력 소진)**
- 대포혈(大包, 비21) 사법 → 전신 이완, 관절 무력증

**실열성 전신통 원칙**
- 해당 경락 화혈(火穴) 사(瀉) + 수혈(水穴) 보(補) → 빠른 진통

### 四四部位(상완) 핵심 혈자리

**견중(肩中) ★★★**
- 위치: 견봉 하 2.5촌, 팔 정중앙 선상
- 주치: 무릎 통증 기본혈 ('밑반찬' 혈), 엉덩이·목 피부병, 비출혈
- 배합: 건중 → 청혈(고지혈증)

**견봉(肩峰) ★**
- 위치: 견봉 끝 하 5분
- 주치: 유방 질환(유선염·유두염·유방암), 고혈압, 팔 마비

**후추(後椎)·수영(首英) ★**
- 위치: 천정(삼초10) 상방
- 주치: 기립 시 요통(앉았다 일어날 때), 노인 야간 기침

### 五五部位(족저) 핵심 혈자리

**화포(火包)**
- 위치: 발바닥 제2지 기저부 횡문 중앙
- 주치: 심장 질환(협심증·심근경색), 난산·태반불출 방혈

**해표(海豹) ★★**
- 위치: 엄지발가락 내측면 중앙
- 주치: 요의빈삭(빈뇨), 부인과 염증, 엄지손가락 염좌

**목부(木婦) ★★**
- 위치: 제2발가락 2절 외측
- 주치: 부인병 성혈(적백대하·생리통·자궁염), 요실금·야간뇨
- 배합: 해표 → 비뇨기·부인과 콤비
...
**정회(正會 = 백회) ★★★**
- 위치: 머리 정중앙
- 주치: 중풍 언어장애, 반신불수, 사지 진전

**진정(鎭靜) ★★★**
- 위치: 인당(EX-HN3) 상 3분
- 주치: 불면, 신경쇠약, 사지 경련, 정서 불안
...
**수금(水金)·수통(水通) ★★★**
- 위치: 입술 하방
- 주치: 만성 기침·천식·구토·딸꾹질 (기를 내리는 하기(下氣) 작용)
- 임상: 15년 만성 기침 1회 치료 사례

**비익(鼻翼) ★★★**
- 위치: 콧날개 외측
- 주치: 피로 회복, 평형 감각, 비염, 좌골신경통

### 八八部位(대퇴부) 핵심 정리

| 혈군 | 위치 | 주치 |
|------|------|------|
| 통관·통산·통천 | 허벅지 앞쪽 정중앙 | 심장병·입덧·슬개통 |
| 통신·통위·통배 | 허벅지 안쪽 비경 | 부종·신장염·당뇨 |
| 상삼황(명황·천황·기황) | 허벅지 안쪽 정중앙 | 간질환·만성피로·디스크 |
| 사마 상·중·하 | 허벅지 바깥쪽 | 피부병·비염·천식·기병 |
| 중구리 | 허벅지 외측(풍시) | 측면통증·좌골신경통 |
| 족해 | 무릎 위(양구 부근) | 훈침·약물중독 해독 |

**고혈압 주의**: 통천 → 고혈압 환자에게 1혈만 사용 (양측 자침 금지 재확인)
